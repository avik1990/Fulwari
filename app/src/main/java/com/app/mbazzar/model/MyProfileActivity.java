...
import com.app.mbazzar.Dashboard;
...
public class MyProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void UpdateUserDetails() {
        ...
        Call<BaseResponse> call = redditAPI.UserUpdateDetails(Preferences.get_userId(mContext), user_firstname, user_lastname, user_phoneno, user_email, user_address, user_state, user_city, user_zipcode);
