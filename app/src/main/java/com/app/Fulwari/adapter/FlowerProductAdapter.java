...
public class FlowerProductAdapter extends RecyclerView.Adapter<FlowerProductAdapter.MyViewHolder> {

    List<FlowerProductBean.ProductDatum> countryList;
    Context mContext;
    ...
    public FlowerProductAdapter(Context mContext, List<FlowerProductBean.ProductDatum> countryList, AdapterPos adapterPos, UpdateCartCount updateCartCount) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final FlowerProductBean.ProductDatum c = countryList.get(position);
        ...
        holder.tv_price_discount.setText("\u20B9"+c.getProduct_price());
        holder.tv_price_discount.setPaintFlags(0);
